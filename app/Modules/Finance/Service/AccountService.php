...
use App\Modules\Finance\Middleware\ServiceMiddleware;
use App\Modules\Finance\Repository\AccountRepository as Account;
...
//    }
    ...
    {
        $repo = app()->make(AccountRepository::class);
        return $repo->find('1067423096098639360')->toArray();
