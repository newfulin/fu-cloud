...
//		$inputObj->SetSpbill_create_ip($_SERVER['REMOTE_ADDR']);//终端ip
        ...
        $params = array(
            'appid' => $inputObj->GetAppId(),
            'mch_id' => $inputObj->GetMch_id(),
            'noncestr' => $inputObj->GetNonce_str(),
            'sign' => $inputObj->GetSign(),
            'body'  =>  $inputObj->GetBody(),
            'out_trade_no' => $inputObj->GetOut_trade_no(),
            'total_fee' =>  $inputObj->GetTotal_fee(),
            'spbill_create_ip'  => $inputObj->GetSpbill_create_ip(),
            'notify_url' => $inputObj->GetNotify_url(),
            'trade_type' => $inputObj->GetTrade_type(),
        );
